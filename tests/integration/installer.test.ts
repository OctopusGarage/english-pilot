...
describe('Claude installer commands', () => {
  ...
  it('installs a Claude hook script with --yes', () => {
    ...
    const settingsPath = join(installHome, '.claude', 'settings.json');
...
describe('Codex installer commands', () => {
  ...
  it('installs Codex UserPromptSubmit and Stop hooks with --yes', () => {
            ...
            hooks: [
              {
                type: 'command',
                command: 'english-pilot hook codex --stdin',
                statusMessage: 'Recording English note',
              },
            ],
          },
        ],
